...
const Hero = () => {
    ...
    return (
        <section id="hero" className="relative min-h-[calc(100vh-80px)] overflow-hidden flex items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-0">
            ...
            <div className="w-full relative z-10">
                <div className="max-w-3xl">
                    <p className="text-primary dark:text-blue-400 font-medium tracking-wide mb-2 uppercase text-sm">
                        Hi, my name is
                    </p>
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-4 pb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-400 dark:via-purple-400 dark:to-indigo-400 bg-300% animate-text-gradient">
                        {name}.
                    </h1>
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-600 dark:text-gray-400 mb-6 group">
                        I'm a {title}.
                    </h2>
